...
namespace metapod
{
  ...
  namespace Spatial
  {
    ...
    struct rmca_traits_minus
    {
      typedef rmca_traits<
	traits_op1::ind_X,
	  traits_op1::ind_Y,traits_op1::ind_Z,
	  -traits_op1::value_X,-traits_op1::value_Y,-traits_op1::value_Z> traits_opp;
	...
	return r;
      ...
      template< typename traits_rhs,
		typename traits_lhs= rmca_traits_mul<traits,traits_rhs> >

      RotationMatrixChangeAxis<traits_lhs>
	operator*(const RotationMatrixChangeAxis<traits_rhs> &) 
      {
	RotationMatrixChangeAxis<traits_lhs> r;
	return r;
      }
